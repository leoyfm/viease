...
@section('content')
  <div class="banner"><img width="100%" src="{{ asset('activity/tour/images/top_banner.jpg') }}" alt="" /> </div>
  <!-- box -->
  <div class="box">
    <div class="shai">
      <div class="tit txt_c">横店影视城 文化之旅</div>
      <form id="submit_form" class="form" method="post" action="">
        ...
        <div class="pic">
          ...
          <div class="row" id="container">
            <button id="pickfiles" class="btn-primary btn-lg btn-block sub bg" type="submit" style="background-image:url({{ asset('activity/tour/images/file_pic.jpg')}});"></button>
        ...
        <div class="txt_c">
          <div class="btn dis_ib bg2"><a class="txt_c dis_ib" href="{{url('/activities/tour/index?activity=13')}}" title="返回首页">返回首页</a></div>
          <div class="btn dis_ib bg3"><i class="fa fa-arrow-right"></i>
            <a id="submit" class="submit" style="background-color:inherit;" href="javascript:void(0)">晒一下</a>
          </div>
        </div>
      </form>
    </div>
...
<script type="text/javascript">
  $(function(){
    ...
    var uploader = Qiniu.uploader({
      ...
      uptoken_url: 'uploadurl?activity=13', //Ajax请求upToken的Url，**强烈建议设置**（服务端提供）
